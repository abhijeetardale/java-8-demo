...
//        GridNode<Integer> below = null;
    ...
    public static void main(String[] args) {
        ...
        List r0 = new ArrayList<Integer>(List.of(1,0,0,0));
        List r1 = new ArrayList<Integer>(List.of(1,0,0,0));
        List r2 = new ArrayList<Integer>(List.of(1,0,0,0));
        List r3 = new ArrayList<Integer>(List.of(1,0,0,0));
        grid.add(0, r0);
        grid.add(1, r1);
        grid.add(2, r2);
        grid.add(3, r3);
